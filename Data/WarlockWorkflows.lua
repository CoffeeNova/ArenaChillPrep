...
ACP.Data.WarlockWorkflows = {
    ...
    defaultDefinitions = {
        ...
        [2] = { enabled = true, name = "2s no sacrifice", steps = { { type = "summon", spellName = "Summon Imp", spellID = 688 }, { type = "createItem", spellName = "Create Healthstone", spellID = 27230, itemID = 22105 }, { type = "createItem", spellName = "Create Healthstone", spellID = 11730, itemID = 19012 }, { type = "pet", spellName = "Fire Shield", spellID = 27269, target = "player" }, { type = "pet", spellName = "Fire Shield", spellID = 27269, target = "party1" }, { type = "summon", spellName = "Summon Felhunter", spellID = 691 }, { type = "cast", spellName = "Soul Link", spellID = 19028, target = "player" }, { type = "createItem", spellName = "Create Healthstone", spellID = 27230, itemID = 22105 }, { type = "createItem", spellName = "Create Healthstone", spellID = 11730, itemID = 19012 }, { type = "createItem", spellName = "Create Spellstone", spellID = 28172, itemID = 22646 }, { type = "cast", spellName = "Fel Armor", spellID = 28189, target = "player" }, { type = "equipItem", itemID = 22646, itemName = "Master Spellstone" }, { type = "cast", spellName = "Detect Invisibility", spellID = 132, target = "player" }, { type = "cast", spellName = "Unending Breath", spellID = 5697, target = "player" }, { type = "cast", spellName = "Detect Invisibility", spellID = 132, target = "party1" }, { type = "cast", spellName = "Unending Breath", spellID = 5697, target = "party1" }, { type = "cast", spellName = "Shadow Ward", spellID = 28610, target = "player" } } },
